...
public class SmtpServerTest {
	...
	public void init() throws Exception {
		...
		message = Message.Builder.of().setFrom("bob@test.com").setTo("bill@test.com").setSubject("Hello").setDate(new Date())
				.generateMessageId("localhost").setBody("This is a message just to say hello.", Charsets.ISO_8859_1).build();
	}
